...
int main(int argc, char** argv){
  //CHANGED
	...
	// NOT NEEDED FOR UDP
	// In tcp this checks if server exists
	// because udp does not have this, could send to server who doesn't exist
	...
	if(e < 0){
		...
		while (fgets(line, 5000, stdin) != NULL) {
			...
			int senderr = sendto(sockfd, line,strlen(line)+1,0,(struct sockaddr*)&serveraddr, sizeof(serveraddr));
